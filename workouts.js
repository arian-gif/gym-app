...
window.WORKOUTS = {
  "Upper A": [
    ...
    { name: "Dead Hang", sets: 1, timed: true, note: "20-30s — decompress after overhead pressing" },
    ...
    { name: "Dead Hang", sets: 1, timed: true, note: "20-30s — decompress after overhead extensions" },
  ...
  "Upper B": [
    ...
    { name: "Seated Cable Rows", sets: 2, note: "No loaded spinal flexion" },
